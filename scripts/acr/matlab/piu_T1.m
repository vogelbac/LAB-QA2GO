...
for column = yco:ycu,
    ...
    im_circle = img1(column,dim2_circle,7);
...
im1_circle = img1(locmx_dim1,pos1_row,7);
im2_circle = img1(locmn_dim1,pos2_row,7);
...
max_wert = img1(locmx_dim1,locmx_dim2,7)
min_wert = img1(locmn_dim1,locmn_dim2,7)
...
signal_high = img1(yh1:yh2,xh1:xh2,7);
mean_high = mean(mean(signal_high)) 
signal_low = img1(yl1:yl2,xl1:xl2,7);
...
set(bild, 'PaperUnits', 'centimeter', ...
   ...
   'PaperSize', [16, 6]);
piu_bild = sprintf('piu_%s',nameT1); 
print( gcf, '-dpng', piu_bild );

fname_result = sprintf('PIU_T1_Results.txt');
%Parameter speichern
