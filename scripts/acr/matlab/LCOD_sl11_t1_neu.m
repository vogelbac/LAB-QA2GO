function LCOD_sl11_t1_neu()
global img1 dim1_T1 dim2_T1 score_sl11_t1 dir_results
...
for column = pos2ob:pos1un,
	...
	im_circle = img1(column,dim2_circle,10);
...
set(f,'Name','LCOD_sl11_t1');
print(f,[dir_results 'LCOD_sl11_t1'],'-dpng');
...
score_sl11_t1 = count1+count2+count3+count4+count5+count6+count7+count8+count9+count10
