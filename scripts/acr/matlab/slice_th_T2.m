...
roi_th(:,1:10,1) = 0;
roi_th(:,dim2_ROI-10:dim2_ROI,1) = 0;
...
find(sum_ramp_left > 0)
sum(find(sum_ramp_left > 0))
if (sum(find(sum_ramp_left > 0)) == 0)
	tempx1 = pos_x1+10;
	pos_x1 = tempx1
	tempx2 = pos_x2-10;
	pos_x2 = tempx2
...
set(bild, 'PaperUnits', 'centimeter', ...
   ...
   'PaperSize', [12, 10]);
sl_th_bild = sprintf('Schichtdicke_%s',nameT2); 
