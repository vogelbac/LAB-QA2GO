function LCOD_sl12_neu()
global img2 dim1_T2 dim2_T2 score_sl12 dir_results
...
score_sl12 = count1+count2+count3+count4+count5+count6+count7+count8+count9+count10
...
set(f,'Name','LCOD_sl12_t2');
print(f,[dir_results 'LCOD_sl12_t2'],'-dpng');
