...
%Interpolation
[x,y]=meshgrid(1:dim1_T1);  % %Bildgroesse quadratisch dim1=dim2
[xi,yi]=meshgrid(1:0.25:dim1_T1);
I2(:,:,1)=interp2(x,y,double(img1(:,:,1)),xi,yi,'cubic');
I12(:,:,1) = interp2(x,y,double(img1(:,:,11)),xi,yi,'cubic');
...
%Randbereiche auf Null setzen wegen moeglicher Artefakte
img_seg(1:20,:) = 0;
img_seg(a1-20:a1,:) = 0;
img_seg(:,1:20) = 0;
img_seg(:,a2-20:a2) = 0;

%Auschnitt waehlen fuer bars
...
%Auschnitt waehlen fuer die Balken
...
set(bild, 'PaperUnits', 'centimeter', ...
   ...
   'PaperSize', [18, 10]);
sl_pos_bild = sprintf('Schichtposition_%s',nameT1); 
print( gcf, '-dpng', sl_pos_bild );

fname_result = sprintf('Schichtposition_T1_Results.txt');
%Parameter speichern
