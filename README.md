...
# Download
The LAB–QA2GO tool is a virtual machine based on [Virtual Box](https://contao.org/de "Official Virtual Box Site"). The image can be downloaded and must be imported at the client.
